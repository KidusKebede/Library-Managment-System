...
public class TestData {
	...
	public static void main(String[] args) {
		...
		System.out.println(da.readRecordMap());
	}
	...
	// create records
	List<CheckoutRecordEntry> records = new ArrayList<>();

	public void checkoutRecordData() {
		Book bk1 = new Book("23-11451", "The Big Fish", 21, Arrays.asList(allAuthors.get(0), allAuthors.get(1)));
		Book bk2 = new Book("28-12331", "Antartica", 7, Arrays.asList(allAuthors.get(2)));

		BookCopy bkc1 = new BookCopy(bk1, bk1.getCopies().length, true);
		BookCopy bkc2 = new BookCopy(bk2, bk1.getCopies().length, true);
		BookCopy bkc2_2 = new BookCopy(bk2, bk1.getCopies().length + 1, true);

		CheckoutRecordEntry entry1 = new CheckoutRecordEntry("2022-10-13", 21, bkc1);
		records.add(entry1);

		CheckoutRecordEntry entry2 = new CheckoutRecordEntry("2022-11-14", 7, bkc2);
		records.add(entry2);

		CheckoutRecordEntry entry2_2 = new CheckoutRecordEntry("2022-11-15", 7, bkc2_2);
		records.add(entry2_2);

		DataAccessFacade.loadRecordMap(records);
	}
